...
L2=[[Q(2),Q(-2)],[Q(-2),Q(2)]]
K2=[[Q(1),Q(-1)],[Q(-1),Q(1)]]
assert charpoly_2x2(L2)==(Q(1),Q(-4),Q(0)) # {0,4}
assert charpoly_2x2(K2)==(Q(1),Q(-2),Q(0)) # {0,2}
PY
...
Quickstart: bash init-aqarion-replay-lab-20260914.sh
Creates tests/receipts/src/ENGINES/FIXTURES with git + ignore.
EOF

cd "$DIR"
git init -q
git add -A >/dev/null 2>&1 || true
echo "[init] $DIR ready — place this file in QUICKSTART/AQARION-RIP/"
