# CLAIMLOCK-PATCH-20260915-SV002 v1.0.2
patch_version: "1.0.2"
...
gates:
  - id: G-DOMAIN-001
    ...
    rule: >
      For m=2, L_m = [[2,-2],[-2,2]] is Laplacian of 2-edge multigraph.
      NOT simple K2 Laplacian [[1,-1],[-1,1]].
      Any claim identifying L2 with SimpleGraph.Cycle must be REJECTED.
    evidence: exact_rational_eigenvalue_comparison
    status: FROZEN
  - id: G-RESISTANCE-001
    name: "Resistance matrix formula firewall"
    rule: >
      ||Omega||_F^2 = (m^4-1)/30 (old /12 REFUTED at m=2).
      tr(Omega^3) = (m^2-1)(m^2-4)(11m^2+13)/2520 (old negative form REFUTED at m=3).
  ...
  - id: G-LITERATURE-001
    ...
    rule: >
      Reference flagged NOT INDEPENDENTLY VERIFIED.
